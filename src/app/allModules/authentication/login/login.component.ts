...
export class LoginComponent implements OnInit {
  ...
  UpdateMenu(): void {
    ...
    //   );
    // }
    if (this.MenuItems.indexOf('Questionaries_Dashboard') >= 0) {
      this.children.push(
        {
          id: 'dashboard',
          title: 'Dashboard',
    ...
    if (this.MenuItems.indexOf('Questionaries_NewForm') >= 0) {
      this.children.push(
        {
          id: 'newform',
          title: 'Newform',
    ...
    if (this.MenuItems.indexOf('Questionaries_Preview') >= 0) {
      this.children.push(
        {
          id: 'preview',
          title: 'Preview',
    ...
    if (this.MenuItems.indexOf('Questionaries_Active') >= 0) {
      this.children.push(
        {
          id: 'active',
          title: 'Active',
    ...
    if (this.MenuItems.indexOf('Questionaries_Option') >= 0) {
      this.children.push(
        {
          id: 'option',
          title: 'Option',
